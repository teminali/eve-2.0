...
print(len(words), "unique legitimatized words", words)


pickle.dump(words, open(f"models/chatbot/{lang}/1/words.pkl", "wb"))
pickle.dump(classes, open(f"models/chatbot/{lang}/1/classes.pkl", "wb"))
...
# actual training Create model - 3 layers. First layer 128 neurons, second layer 64 neurons and 3rd output layer
...
model.save(f"models/chatbot/{lang}/1/eve_model.h5", hist)
print("model created")
